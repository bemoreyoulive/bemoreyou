...
const asbMayIdeas: AsbIdea[] = [
  ...
  { id: "may-2", week: "Week 1 · Friday", type: "Expertise", bold: "2/5", title: "Finance Simplified: The Money's There. But Is It Actually Yours?", hook: "The bank balance looks healthy. You feel okay. But there's a VAT bill coming, corporation tax due in a few months, and a supplier invoice you'd half-forgotten about. That money in your account isn't all yours. (Hook option from 14th May Biz Expo intel: 'I met a business owner last week who'd been managing cash flow by just... not looking at it. He said it had been \'working itself out\'. Until it didn't.')", direction: "Write this post for Andy Scott Barrett, a Fractional Finance Director writing LinkedIn content for SME owners. The bank balance is a trap — it shows a number, not the truth. Walk through the hidden claims that sit between the balance and what's actually spendable: VAT, corporation tax, committed supplier costs, pre-sold revenue not yet earned. Use a simple worked example — real numbers make this real. The cash flow 'working itself out' angle (from expo conversations) is a vivid, relatable way in: a lot of owners manage cash by hoping, not planning. The tone is calm and factual, with a slight edge of 'I've seen how this ends.' No jargon. No list posts. End on a practical question the reader can ask themselves tonight.", questions: "Have you worked with someone who found out their bank balance wasn't what they thought? What's the most common hidden claim owners don't account for? Can you give a worked example — e.g. £80k in the account, here's what's actually committed? [14th May Biz Expo: Several owners described managing cash by gut feel or just 'seeing how it goes' — if you've seen that, what usually happens next?]", cta: '"Before you make your next big spend — do you know what\'s already committed from that balance?"' },
  ...
  { id: "may-6", week: "Week 3 · Friday", type: "Expertise", bold: "2/5", title: "Finance Simplified: One of Your Products Is Carrying the Rest. Do You Know Which One?", hook: "Overall, the business looks profitable. But break it down by product or service and a different picture appears. One is doing the heavy lifting. A couple are barely covering their costs. And one might actually be losing money. (Hook option from 14th May Biz Expo intel: 'At a business expo last week, I asked an owner which of their products made the most money. They said the one that sold the most. Those are two very different things.')", direction: "Write this post for Andy Scott Barrett, a Fractional Finance Director writing LinkedIn content for SME owners. This is a diagnosis post — not just 'do your numbers,' but 'do you know which part of your business is actually working?' Use the Lego parallel if it fits: a child thinks every piece of the set has equal value; it's the pieces that fit together perfectly that make the whole thing work. The expo context adds weight here — multiple business owners described having complex product ranges without knowing which ones were profitable. That's not laziness, it's a gap nobody's filled for them. Walk through what product-level margin analysis actually shows, using an anonymised example if you have one. The punchline: finding the loser doesn't mean killing it. Sometimes there's a reason to keep it. But you should know you're keeping it.", questions: "What's the most common reaction when you show an owner their product-level margin breakdown for the first time? Can you share an anonymised example — what the owner thought vs. what the numbers showed? Are there legitimate reasons to keep a loss-making product in a range — and what are they? [14th May Biz Expo: Several owners had complex product ranges but couldn't tell you which ones were profitable. What does that typically mean for how they're pricing and selling?]", cta: '"Do you know which of your products or services is your most profitable — not the one that sells the most, but the one that actually makes you the most money?"' },
  { id: "may-7", week: "Week 4 · Mid-week", type: "Personal", bold: "2/5", title: "She Could Finally Sleep", hook: "She ran a good business. Investors kept asking questions about cash flow. She knew the answers — she just couldn't get to them fast enough, and it was grinding her down.", direction: "Write this post for Andy Scott Barrett, a Fractional Finance Director writing LinkedIn content for SME owners. This is a client story post — told as a moment, not a case study. The transformation isn't the spreadsheet — it's the weight that lifted. Keep her anonymous throughout. The expo context reinforces why this lands: a surprising number of SME owners are managing finances completely alone, not because they're confident about it, but because they've never thought there was another option. That's the gap this post speaks to. The 'sleeping better' detail is the emotional anchor — don't bury it. Lead with the stress. Then the shift. Then what that actually looked like in her day-to-day. Resist the urge to explain what you did technically. The audience doesn't need the method. They need to feel the before and the after.", questions: "What was the atmosphere early on — was she stressed, resigned, resigned to being stressed? What specifically changed once planning was in place — was it a spreadsheet, a call, a forecast? What did 'sleeping better' look like practically? [14th May Biz Expo: Many owners described managing finances alone as just 'how it is' — does this client's story connect to that? What was her equivalent of that assumption?]", cta: '"Financial pressure is a weight most business owners carry alone. You don\'t have to."' },
  { id: "may-8", week: "Week 4 · Friday", type: "Expertise", bold: "2/5", title: "Finance Simplified: What Break-Even Actually Means — and Why Most People Get It Wrong", hook: "Break-even sounds simple. In practice, most business owners either don't know theirs, or know a number that doesn't account for everything it should.", direction: "Write this post for Andy Scott Barrett, a Fractional Finance Director writing LinkedIn content for SME owners. Break-even isn't just a formula — it's the foundation for pricing decisions, growth plans, and knowing whether a new hire is viable. Most owners who've heard of it have a rough number; most rough numbers are wrong. Walk through it clearly with an example — simple enough that someone with no finance background can follow, sharp enough that someone who thinks they already know feels something click. The expo context adds a useful angle: pricing without understanding costs came up repeatedly on 14th May as a pattern. Break-even is often the missing piece behind that. End on what changes once someone actually has this number — what decisions feel different.", questions: "What's the most common mistake when people calculate their own break-even? Can you walk through a simple worked example — ideally one that produces a surprising result? What decisions typically change once someone knows their real break-even? [14th May Biz Expo: Multiple owners were pricing without understanding their costs — how does break-even relate to that? Is it usually the missing piece?]", cta: '"Do you know your break-even point — and does it account for your own time?"' },
];
...
const asbJulyIdeas: AsbIdea[] = [
  ...
  { id: "jul-2", week: "Week 9 · Friday", type: "Expertise", bold: "2/5", title: "Finance Simplified: The Business Was Profitable. They Were Three Months From Running Out of Cash.", hook: "The business had profitable contracts. Revenue was growing. They'd never needed a cash flow forecast and had always been fine. Then they took on some bigger deals — with costs up front and payment at the end. Once we put a forecast in place, the picture changed. (Hook option from 14th May Biz Expo intel: 'I met an owner at a business expo last week who told me cash flow had always just \'worked itself out.\' I nodded. Asked a few questions. It had worked itself out, yes — but only because a supplier had quietly stopped invoicing them for four months. That wasn't luck. That was a deferred disaster.')", direction: "Write this post for Andy Scott Barrett, a Fractional Finance Director writing LinkedIn content for SME owners. This is a real client story — told as a moment, not a case study. A profitable business nearly ran out of cash within three months because of payment timing on larger contracts. Tell the story. Keep the client fully anonymous throughout. The pay-off: they said it was worse than they'd thought — but they could sleep at night, because they knew, and there was still time to act. Knowing is better than not knowing, even when what you find out is uncomfortable. Two expo-sourced details that add texture: (1) several owners described managing cash flow by gut feel or hoping it 'works itself out,' and (2) the owner who hadn't noticed a supplier hadn't invoiced them for months — it felt like a lucky spell, it was actually a deferred liability. Think of it like a delayed flight — the gate agent smiling and saying nothing doesn't mean everything's fine. At some point the truth arrives. End on: a forecast doesn't prevent problems, it gives you time to act.", questions: "What did the business look like from the outside when you first got involved — growing, healthy on the surface? When did the forecast first show what was coming — how far out were they? What exactly did they do to fix it? [14th May Biz Expo: Cash flow 'working itself out' and long payment terms creating hidden pressure came up as themes. Can you weave one of those in as a detail that reinforces the story?]", cta: '"Do you have a forward-looking cash flow forecast — or just last month\'s accounts?"' },
  ...
  { id: "jul-8", week: "Week 12 · Friday", type: "Expertise", bold: "2/5", title: "Finance Simplified: Costly Mistakes Don't Announce Themselves. They Show Up Afterwards.", hook: "Work that looked profitable turns out to destroy margin. Costs are committed to that the business can't sustain. A hire is made too early. Usually you don't find out until it's too late to do much about it. (Hook option from 14th May Biz Expo intel: 'Last week at a business expo I heard three separate versions of the same story. Different businesses, different sectors. Same ending: a decision that made sense at the time, which quietly destroyed margin over the next six months. Nobody realised until the damage was done.')", direction: "Write this post for Andy Scott Barrett, a Fractional Finance Director writing LinkedIn content for SME owners. This post is about the cost of operating without financial visibility — told through real, anonymous examples. Not scary. Matter-of-fact. These things happen. The expo gave this post a broader base: losing money on contracts without knowing why, outsourcing decisions made without financial analysis, complexity product ranges that quietly eat margin — all of these came up in real conversations on 14th May. Use 2-3 concrete, anonymised scenarios. A good analogy: it's a bit like flying a plane with the instrument panel turned off. The cockpit is perfectly functional. You just don't know what you don't know — until the warning lights come on. Finish on the constructive note: this isn't about being perfect. It's about having enough information to course-correct before things become serious. The difference between a mistake and a crisis is usually how quickly you found out.", questions: "What are the most common guesswork-driven mistakes you see — pricing, hiring, outsourcing? Can you share 2–3 anonymised examples where better information would have changed the decision? What's the earliest warning sign that a business is operating without enough financial visibility? [14th May Biz Expo: Losing money on contracts without knowing why, and outsourcing without financial analysis, both came up as patterns. Do either of these map to real examples you can use anonymously?]", cta: '"What\'s the most expensive decision you\'ve made based on gut feel — and how did it turn out?"' },
];

const asbAugustIdeas: AsbIdea[] = [
  { id: "aug-1", week: "Week 13 · Mid-week", type: "Personal", bold: "3/5", title: "\"I'm Just Bad With Money.\" No. You're Not.", hook: "I hear this a lot. Usually within the first ten minutes of meeting someone. 'I'm just not a numbers person.' 'Finance has never been my thing.' 'I'm bad with money.' It's almost never true.", direction: "Write this post for Andy Scott Barrett, a Fractional Finance Director writing LinkedIn content for SME owners. Address the self-limiting belief that stops right-fit clients from even considering getting help. The real issue isn't that they're bad with money — it's that nobody has ever helped them understand what their numbers mean and what to do next. The expo made this more vivid: managing finances alone came up repeatedly as just 'how it is.' Not because owners are confident. Because they've never thought there was another way. There's a specific version worth naming: knowing the 'what' (the figures) but not the 'so what' (what they mean for the business). That gap isn't a character flaw. It's a missing layer. Think of it like knowing how to read a map but having no idea where you're trying to get to — the skill is there, the context isn't. Keep this warm, not patronising. You're not telling people they're wrong. You're releasing them from a story they've been telling themselves for years. End on: the owners who say this are often the most coachable, because they're honest about what they don't know.", questions: "What do people usually mean when they say they're bad with money — is it numeracy, interpretation, or just anxiety? What's the most common thing that changes once someone understands their own numbers? Have you worked with someone who genuinely believed this about themselves — what was the moment something shifted? [14th May Biz Expo: Managing finances alone came up as a recurring pattern — do you think the 'I'm bad with money' belief and going it alone often go together?]", cta: '"Do you consider yourself a numbers person — or have you always left that to someone else?"' },
  { id: "aug-2", week: "Week 13 · Friday", type: "Expertise", bold: "3/5", title: "Finance Simplified: You Want to Sell the Business for £3 Million. What Does It Need to Look Like to Get There?", hook: "Most business owners I meet have a number in mind. A figure they'd take. An exit they're quietly working towards. Very few of them have mapped out what the business actually needs to look like financially to make that number realistic. (Hook option from 14th May Biz Expo intel: 'At a business expo last week I asked an owner what his exit goal was. He said the number immediately, without hesitating. I asked what the business needed to look like financially to get there. Long pause. \'I haven\'t really worked that out yet.\')')", direction: "Write this post for Andy Scott Barrett, a Fractional Finance Director writing LinkedIn content for SME owners. This is a commercially powerful post because it speaks to aspirational owners, not just those in pain. The expo reinforced it: growth without financial foundations was a recurring theme, and the exit goal without a financial plan connects directly. The gap between ambition and roadmap is common. Walk through what it actually takes to build a business that's saleable at a target value: margin trajectory, revenue quality (recurring vs. one-off), clean financials, reduced owner-dependency. The exit plan without financial architecture analogy: it's a bit like deciding you want to run a marathon in two years and then doing absolutely nothing differently today. The goal is real. The path doesn't exist yet. End on the core point: the business you want to exit isn't built at the end — it's built now. Every month without a plan is a month of compounding the gap.", questions: "What's the most common gap between what owners think the business is worth and what it would actually sell for — is it valuation multiples, owner-dependency, messy financials? What are the 2–3 financial levers that most affect exit value for an SME? If an owner said 'I want to sell in five years for £3 million,' what would you look at first? [14th May Biz Expo: The exit goal without a financial plan came up directly — can you incorporate that as a real conversation moment (anonymised) to make the hook land?]", cta: '"Do you have a number in mind — and do you know what the business needs to look like to get there?"' },
  { id: "aug-3", week: "Week 14 · Mid-week", type: "Expertise", bold: "3/5", title: "Finance Simplified: \"I'm Not Ready Yet.\" What That's Usually Costing You.", hook: "The most common thing I hear at the end of a conversation that's gone well: 'I think this is exactly what I need — just not quite yet.'", direction: "Write this post for Andy Scott Barrett, a Fractional Finance Director writing LinkedIn content for SME owners. Address the 'not ready yet' objection as a post — not as a sales tactic, but as a genuine observation about what waiting costs. The expo context makes this sharper: owners described being in businesses they were working IN rather than ON. Not because they didn't want to change, but because they were stuck in a loop of 'once X is sorted, I'll deal with Y.' The thing they're waiting for is usually exactly the thing that needs financial input to resolve. The framing: readiness is a feeling, not a fact. A good analogy: it's a bit like saying you'll start thinking about your health once work calms down. Work never calms down. And the time you spent waiting? That's gone. Keep this non-pushy. You're reflecting back something real, not pressing for a sale. There is a version of 'not yet' that's legitimate — acknowledge it. That's what makes the post trustworthy.", questions: "What's the most common 'not yet' reason you hear — and what's usually underneath it? What has waiting actually cost people you've worked with — can you give a concrete, anonymised example? Is there a version of 'not yet' that IS legitimate — and how do you tell the difference? [14th May Biz Expo: 'Working in not on the business' came up as a pattern — does that connect to the 'not yet' mindset? Are they often the same owner?]", cta: '"What are you waiting for — and is the waiting actually helping?"' },
