...
const AS_CONTENT_WEEK_4: ContentIdea[] = [
  ...
  },
  {
    ...
    guidance: [
      "Snap a van whenever you see one worth reviewing — dirty, no branding, number scrawled in marker, mid-2000s logo. That's your raw material. Ben sent you one and you immediately started breaking it down, so you know the format instinctively.",
      "For a full review, put your face in the bottom corner. Point at the van, the logo, the social page. Cover what you'd change and why. People watch this format for hours.",
      "Keep it honest, not personal. You're not going after the person, you're calling out the standard. End on something like: this is 2026, there's no excuse for this.",
      "Over time, people will start sending you vans. When that starts, the content runs itself.",
    ],
  },
];
