...
const AF_NEXT_MOVE = "Networking is your channel now, and Friday is the big one: BNI as a guest, then a face-to-face with an accountant. Get your 45-second pitch sharp and the expo brochure to the printers. Every conversation feeds your content, your pipeline, and your first client.";

const afTodos = [
  { id: "w1", text: "Finalise the expo brochure and banner, and get them over to the expo organisers", subtext: "Lead with the accountancy hook we built: 'Accountancy firms run on retainers. Most of the work inside those retainers is still done by people.' Keep the pain points (drowning in manual processes, unable to take on new clients), the Sheldon of practice automation line, and your photo. Make sure the formatting is spot on and the colour scheme is sorted the way we discussed on the call, across both the brochure piece and the banner. Rename the prize to 'Five-Step AI Assessment' so it matches your LinkedIn. Send Ben the draft, then get it over to the expo organisers by the end of the week.", section: "This week", tabLink: undefined as { label: string; tab: string } | undefined },
  { id: "w2", text: "Prep and practise your 45-second BNI pitch for Friday", subtext: "You're going to BNI as the accountant's guest, then straight into your 1:1 with him. The full 45-second script and the funny closing lines are in your Brand Assets tab. Open with 'Hi, I'm Andy, often called with affection the Sheldon of practice automation,' run the retainers pitch, and finish on a funny line so they remember you. Read from upright notes, hold eye contact, and bring energy. Visitors pitch last, when the room is tired, so make it land.", section: "This week", tabLink: { label: "Open Brand Assets", tab: "brand" } },
  { id: "w3", text: "Get this week's two accountant chats done, and book the new 1:1s", subtext: "The two accountant conversations have slipped a few times for family reasons. Hold them to it this week. Book the new 1:1s from Tuesday too: the HR host who does numbers and has dabbled with AI, and the business advisor offering to take you as a guest. Research each business first and work from your non-assumption questions. And make a call on the £360 regional group: five accountants on the list, three of whom you already know.", section: "This week", tabLink: undefined as { label: string; tab: string } | undefined },
  { id: "c1", text: "Post your networking reflection, and make it a habit after every event", subtext: "Write up Tuesday's small event while it's fresh: how you've gone from finding networking draining to actually enjoying it, and how you didn't even need to arrive early this time. Tag the people you met. After every event from now on, ask what was different, who you enjoyed talking to, and what you learned, then post it. Grab a photo of the room, even if you're not in it. These are your best-performing posts.", section: "Content & offer", tabLink: { label: "Browse Content Ideas", tab: "content" } },
  { id: "p1", text: "Do the Chris Dillon R&D this week, ready for next week's call", subtext: "Chris has finished the design work. Your job is the R&D: prove you can pull the stats they want from their data using AI. Aim to get it done Friday afternoon so you're ready when Claire is back mid next week. Crack this and Phase 1, a $12k deal, moves, with Phase 2 around $30k behind it. Keep Ben posted.", section: "Pipeline", tabLink: undefined as { label: string; tab: string } | undefined },
  { id: "m1", text: "Keep the momentum going: stay with Ben monthly so the traction doesn't stall", subtext: "Everything's landing at once: networking's clicking, a $12k deal in play, conversations turning into opportunities. This is the worst moment to ease off. From July, drop to one session a month plus the group for £325, down from £500. You keep Ben sharpening your posts, pitch and pipeline, and keeping you accountable as conversations become clients. Lock it in.", section: "Looking ahead", tabLink: undefined as { label: string; tab: string } | undefined },
  { id: "s13", text: "Next session: Session 13 on 24 June 2026 at 9:30am", subtext: "Final session of the original block. Bring: how Friday's BNI and accountant 1:1 went, the expo brochure status, your accountant conversations, the Chris Dillon R&D result, and your thinking on continuing from July.", section: "Next session", tabLink: undefined as { label: string; tab: string } | undefined },
];
...
const afContentStory = [
  { id: "af-story-1", hook: "\"It took me five attempts to pass my English exam. I went on to build software for England Golf, UK Athletics and SwimEngland.\"", grade: 3, tag: "Unused", badge: "Long-form post", priority: false, guidance: "Your own words from onboarding — \"useless at the written word, took 5 times to pass English.\" Lead with the failure, then quietly land the credibility. Don't explain the irony — let the reader feel it. The point of the post isn't \"look what I did\", it's \"the thing schools said I was rubbish at is the thing I now help businesses with.\" Then a soft line about voice-dictating your LinkedIn posts because spoken English still works better than written. This is permission for every founder who's been told they aren't \"the words person\" to stop apologising for it.", prompts: "What did teachers actually say about you back then? When did you realise your brain worked differently rather than worse? Do you still feel it now when you sit down to write a post?", cta: "" },
  { id: "af-story-3", hook: "\"Mum waited 18 months on the NHS for a hip operation. I'm running a business in the middle of all of that.\"", grade: 3, tag: "Unused", badge: "Long-form personal", priority: false, guidance: "The sandwich-year post. Eighteen months on the NHS waiting list. The hip op over New Year, the DVT after. The \"in and out this week, taking it as it comes\" rhythm of running a business while alternating hospital visits. End on the systems point if you want to — if my business needs me sitting in front of it every day, I can't be at the hospital. But the post stands without that. Universal for the 45–60 ICP.", prompts: "What's the bit of running a business through that period that other people don't see? What did you have to let go of? What kept holding up while everything else wobbled?", cta: "" },
  { id: "af-story-4", hook: "\"I have to arrive early to every networking event. If the room's already busy when I walk in, I can't function. And once I'm in, I lock on to one person and don't move.\"", grade: 3, tag: "Unused", badge: "Story post", priority: false, guidance: "Your own honest description of how networking works for you — straight from onboarding and confirmed in session. The point isn't \"I'm bad at networking.\" It's \"this is the operating manual.\" Most people quietly do some version of this — you're just saying it out loud. Land on the wider point: edge-case thinking, arriving prepared, knowing how the room flows. The same things that make you weird at networking are what make you good at fixing broken systems. No autism label needed — the post does the work without one.", prompts: "When did you first notice the early-arrival thing? What does it actually let you do that other people miss? What's the worst networking event you've walked into late?", cta: "" },
  { id: "af-story-5", hook: "\"I don't start work until 9am. Before that there's journaling, stretching, mindfulness — about an hour and a half. It's not a productivity hack. It's how I stay functional.\"", grade: 2, tag: "Unused", badge: "Story post, no CTA", priority: false, guidance: "Your actual morning. Going through yesterday, journaling, stretches, mindfulness — 60 to 90 minutes before anything work-related happens. Most founder content about routines is hustle-coded. This one isn't. It's the opposite — if I skip this, the day doesn't work. Plays directly into your \"repeatable beats heroic\" line. Quietly distinctive in a market full of \"I'm up at 5am crushing it\" posts. No CTA needed.", prompts: "What happens to the day if you skip it? When did you start doing it? What part of it do you most want to drop and never do?", cta: "" },
  { id: "af-story-6", hook: "\"My business coach asked what made us different. I sat there for a moment. Eventually I said: nothing, really.\"", grade: 3, tag: "Unused", badge: "Long-form post", priority: false, guidance: "The before the pivot story — distinct from the \"I let my only employee go\" one. When you took over the business in 2021 you brought a load of existing clients with you. They kept you afloat. Then over the next couple of years the work quietly dried up — Wix, WordPress, AI tools chewing through the bespoke web dev market. Eventually someone asked you the killer question and you couldn't answer it. That moment of self-honesty is the post. Land it on the broader point: most businesses don't die overnight. They fade. And the people running them often know it before anyone else does. Relevant for any accountancy practice owner watching software eat at their retainer base right now.", prompts: "When was the moment you realised the answer to \"what makes us different\" was nothing? How long did you carry on after that before you actually changed anything? What were you telling clients and yourself in the meantime?", cta: "" },
];

const afContentBelief = [
  { id: "af-belief-1", hook: "\"Whilst anyone can build a system, the question is whether it'll still work in six months.\"", grade: 2, tag: "Unused", badge: "Opinion post", priority: false, guidance: "Your strongest philosophical statement — adapted from your own words and pointed at the implementor positioning. Build a post around it. What does it actually mean in practice? Give examples of systems that get built and break. Position yourself as the person who thinks past the build.", prompts: "What's an example of a system you were asked to build and pushed back on? What did you see that the client didn't? What happened to people who built it anyway?", cta: "If you want someone who'll tell you what the right answer actually is — and then go and build it — I'm in the comments." },
  { id: "af-belief-2", hook: "\"I'd rather be honest and lose the client than knowingly over-promise. This has cost me work. I'd do it again.\"", grade: 3, tag: "Unused", badge: "Belief post", priority: false, guidance: "Your integrity as a differentiator — made concrete with a specific instance. The point isn't \"look how honest I am.\" It's \"this is what working with me actually looks like.\" Speak to the client who's been burned by someone who overpromised before.", prompts: "Can you think of a specific conversation where you said the difficult thing and it cost you the work? What did you say? How did the client react?", cta: "If you've had enough of being sold to — let's have a proper conversation instead." },
  { id: "af-belief-3", hook: "\"The most expensive thing in a growing business isn't the software. It's the manual processes nobody's noticed yet.\"", grade: 2, tag: "Unused", badge: "Belief post", priority: false, guidance: "Reframe cost. Most founders think of systems work as an added cost — they should be thinking about the hidden cost of not having it. What does it cost in time, errors, and growth ceiling to stay on manual processes?", prompts: "What's the most invisible manual process you've seen in a client's business? What was it actually costing them that they hadn't calculated?", cta: "Happy to do a quick sense-check on what your manual processes are actually costing. No pitch, just an honest number." },
];
...
const afContentBobby = [
  {
    ...
    guidance: "The emotional hook here is quiet frustration — the practice owner who knows, deep down, that chasing clients for records is embarrassing. It's not just inefficient, it's a professional image problem. You're a trusted advisor and you're sending the same email asking for the same documents for the fourth time this quarter. Lead with that feeling. The practice owner reading this has either sent that email themselves or watched Bobby send it and cringed. Name that moment specifically. Then make the fix sound boring and obvious — because it is. That's your whole positioning: this isn't clever AI magic, it's plumbing that should have been done years ago.\n\nResearch confirmation (Jaz Grewal, TaxAssist, May 2026): Jaz named chasing clients for records as the single biggest drain on his team's productive hours — his exact words: \"If everybody gave great information all the time, I'm sure we could probably take on double the amount of clients that we currently do.\" He also flagged a specific gap: for VAT returns and bookkeeping work (as opposed to year-end accounts), there is no automated chasing at all — it's entirely manual email. The Pixie portal only automates reminders for portal-based work. This gap is real and specific — use it.",
    prompts: "Think about the practice owners you've spoken to. What's the specific moment when chasing clients stops being a minor irritation and becomes a genuine problem — missing a deadline, a client relationship that gets awkward, a quarter-end that runs two weeks late because three clients didn't submit? What does the owner say when you describe this back to them? What's the version of this that they haven't admitted out loud yet? Jaz's version: VAT and bookkeeping chasing is entirely email-based with no automation — the portal automation only exists for year-end work. That's a very specific angle.",
  ...
  },
  {
    ...
    grade: 2, tag: "Unused", priority: false,
    guidance: "This one is about the absurdity of how accountancy practices actually operate versus how professional they appear externally. From the outside, a well-run practice looks polished and organised. On the inside, Monday morning is six browser tabs, three password resets, and a spreadsheet that hasn't been saved since Thursday. You want the practice owner to recognise that gap — and feel slightly silly about it. Keep the tone dry. You're not lecturing them, you're describing something you've seen so many times it barely surprises you anymore. Then offer the obvious fix like it's the most boring thing in the world. Because it is.\n\nResearch confirmation (Jaz Grewal, TaxAssist, May 2026): This is the single biggest pain Jaz identified when asked the magic wand question. His exact words: \"I spent four hours Sunday night just going through everybody's list to see where things are at and what we need to prioritise this week — and I do that every week, usually either on a Monday morning or Sunday evening.\" That's a specific, vivid, real detail — a practice owner giving up his Sunday evening every single week because he has no dashboard. Use it. He also described his ideal as passive visibility: not actively looking for problems, but being pinged when something slips. He even named a specific feature — a weekly automated summary of which staff members didn't respond to which emails. Karbon (competitor to Pixie, ~£80/user/month) offers some of this. The opportunity: replicate just the visibility features he actually wants at a fraction of the cost.",
    prompts: "What are the actual platforms a junior accountant typically logs into to piece together a status picture? What's the human cost of that — in time, in errors, in the general dread of Monday morning? What would the same person's Monday look like if a single dashboard existed instead? Jaz's Sunday evening is the specific human detail that makes this land — a practice owner manually reviewing 13 staff members' task lists every week because no system does it for him.",
  ...
  },
  {
    ...
    grade: 2, tag: "Unused", priority: false,
    guidance: "The irony here is the thing worth naming: winning a new client should be a good day. Instead, it triggers a half-day of manual admin. The practice owner knows this. They've been meaning to fix it. They haven't, because it only happens occasionally and Bobby handles it. Your job in this post is to make the reader notice how backwards that is. You win business — and your reward is an afternoon of folder creation and copy-pasting. Lead with the victory, then immediately undercut it with the admin reality. That contrast is where the post lives. Keep the tone wry rather than critical.\n\nResearch confirmation (Jaz Grewal, TaxAssist, May 2026): Jaz confirmed onboarding as manually intensive with a specific compliance layer not previously captured. Anti-money laundering (AML) checks are a mandatory part of onboarding — they use a tool called Zama for ID verification, proof of address, and compliance flagging. The requirements keep changing. Even when a supplier (like Zama) releases a new onboarding portal, it creates its own transition overhead. His observation: \"It's tough when our suppliers are continually developing, and then at the same time we're trying to figure out how to do it ourselves.\" This is useful framing — the moving-target problem of compliance-heavy onboarding is a real layer of pain on top of the basic manual steps.",
    prompts: "Walk through the actual onboarding sequence step by step, the way you'd describe it to someone who's never seen it. How many manual steps are there? How many of those could be triggered automatically once a client record is created? What's the version of this that's broken because Bobby was off sick the day the new client signed? Add the AML compliance angle from the Jaz call — the constantly changing requirements and the fact that even purpose-built tools keep shifting the goalposts.",
  ...
  {
    id: "af-bobby-10",
    hook: "Your clients aren't forgetting to send things. Your system is forgetting they already did.",
    whiteboard: "\"Don't Ask For What You've Already Got\"",
    grade: 3, tag: "Unused", priority: false,
    badge: "From Jaz Grewal research call",
    guidance: "This post is about a specific, embarrassing, trust-eroding problem: asking a client for information they already sent three months ago. It happens because the practice has no reliable system for tracking what's been received by email during the year — so at year-end, the team requests everything again. The client pushes back (\"I sent you this in January\") and the practice has no good answer. The emotional hook is the client's frustration and the quiet damage it does to the relationship. You're not the trusted advisor in that moment — you're the disorganised firm that didn't track their documents.\n\nResearch source (Jaz Grewal, TaxAssist, May 2026): Jaz explicitly flagged this as a service quality risk. His practice sometimes receives bank statements or documents throughout the year by email, but has no system to tag or track them against a client record. Pixie allows file attachment but the naming conventions are inconsistent and files still need manual review. So at year-end, they request documents the client already sent. His words: \"Some clients, they will be like, Oh, I sent you this three months ago. Why are you asking for it again?\" He acknowledged it doesn't happen very often — but when it does, it's a problem.\n\nThe post opportunity: this is a trust and reputation angle, not just a process angle. It's the kind of problem a practice owner recognises immediately and feels slightly embarrassed about. Lead with the client's frustration, not the admin overhead.",
    prompts: "What does it actually feel like for a client to be asked for something they already sent? What does it signal about the practice? What's the version of this that costs the practice a client relationship — not just an awkward email? What would the fix look like: a system that logs every document received and tags it to a client record automatically?",
    cta: "If your practice occasionally asks clients for things they've already sent, the fix is simpler than you think. Drop me a message."
  },
  {
    id: "af-bobby-11",
    hook: "How do you know if a client email was ignored? You probably don't.",
    whiteboard: "\"What You Can't See Is What Gets Missed\"",
    grade: 3, tag: "Unused", priority: false,
    badge: "From Jaz Grewal research call",
    guidance: "This is a management and accountability angle, not just a delivery angle. It speaks to practice owners who are scaling — who have handed responsibility to client managers and now have less visibility into what's actually happening with client communications. The fear: a client email sits unanswered for a week, the client is unhappy, and the practice owner doesn't know until the client complains or leaves.\n\nResearch source (Jaz Grewal, TaxAssist, May 2026): Jaz described wanting visibility into whether his client managers are responding to client emails within their service standards — without having to read anyone's inbox. His ideal was specific: a weekly automated summary flagging which staff members didn't respond to which emails, usable in Monday morning team meetings and formal appraisals. His words: \"If there was a system that just pinged me a summary at the end of the week to say these staff members didn't respond to these emails — make note of it in your Monday morning meeting.\" He currently has nothing like this. He relies on clients complaining or him actively checking — neither of which scales.\n\nThis is a different buyer motivation from the typical Bobby posts. It's not about efficiency — it's about control and performance visibility as the practice grows. The practice owner who's promoted client managers and is now slightly anxious about what's happening in their name will recognise this immediately.",
    prompts: "What does the practice owner actually worry about when they hand client relationships to a team? What's the version of this where it goes wrong — a client leaves because an email wasn't answered, and the practice owner finds out too late? What would a weekly email summary look like: which staff members, which client emails, what service standard was missed? How does this connect to appraisals and professional development?",
    cta: "If you've handed client relationships to your team and you're slightly anxious about what you can't see — that's a solvable problem. Happy to show you what that looks like."
  },
];
...
function IdeaCard({ idea, isSack = false, slug }: { idea: ContentIdea; isSack?: boolean; slug: string }) {
  ...
  useEffect(() => {
    ...
    supabase.from("idea_states").select("used").eq("slug", slug).eq("idea_id", idea.id).single()
  ...
  async function toggleUsed(e: React.MouseEvent) {
    ...
    await supabase.from("idea_states").upsert(
      { slug, idea_id: idea.id, used: next },
      { onConflict: "slug,idea_id" }
    );
    setSaving(false);
  }

  const priorityBg = used ? "#f3f2f0" : isSack ? "#fff5ee" : idea.priority ? "#f0f7ed" : "#fff";
  const leftBorder = used ? "3px solid #B0A89E" : isSack ? "3px solid #6b2a00" : idea.priority ? `3px solid ${AF_COLOR}` : "1px solid #E0DBD3";

  return (
    <div style={{ background: priorityBg, border: "1px solid #E0DBD3", borderLeft: leftBorder, borderRadius: 3, padding: "20px 24px", marginBottom: 8, opacity: used ? 0.6 : 1, transition: "opacity 0.2s ease" }}>
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12, marginBottom: isSack ? 4 : 12 }}>
        <div style={{ fontWeight: 600, fontSize: "0.95rem", color: used ? "#7A746E" : isSack ? "#6b2a00" : "#1C1C1C", lineHeight: 1.5, textDecoration: used ? "line-through" : "none", flex: 1 }}>
          {idea.hook}
        ...
        <button
          ...
          style={{
            ...
            border: `1px solid ${used ? "#B0A89E" : "#2e7d4f"}`,
            background: used ? "#f3f2f0" : "#e8f5ee",
            color: used ? "#7A746E" : "#2e7d4f",
      ...
      <div className="dash-page" style={{ maxWidth: 1160, margin: "0 auto" }}>
        ...
        {activeTab === "content" && (
          <div>
            ...
            {contentSubTab === "story" && (
              <>
                {afContentStory.map((idea, i) => <IdeaCard key={i} idea={idea} slug={slug} />)}
                <div style={{ marginTop: 28 }}>
                  <Callout type="amber">
                    <strong>Needs clarification from Andy — possible future stories</strong>
                    <p style={{ fontSize: "0.85rem", margin: "8px 0 8px" }}>Two stories surfaced in transcripts but there isn't enough detail yet to build a post from. Don't write to either of these until Andy has filled in the gaps in a session — but worth flagging because both could become strong content if the texture is there.</p>
                    <ul style={{ fontSize: "0.85rem", margin: 0, paddingLeft: 18 }}>
                      <li style={{ marginBottom: 6 }}><strong>The car salesman client.</strong> Andy mentioned in passing he was about to start an afternoon piece of work for a car salesman client — &quot;he pays for the work&quot; — and recognised the client isn&apos;t ICP. There&apos;s no story arc yet, just the discomfort. <em>Could become</em>: a &quot;work that pays the bills vs. work that builds the brand&quot; post. Ask Andy what the work actually was, why he took it, and whether he&apos;d take it again.</li>
                      <li><strong>The private founders group / award.</strong> Andy referenced being part of a paid private founders group with &quot;a lot of big entrepreneurs&quot; in it, and there&apos;s a thread about an award. No specifics on what the group is, what the award was, or whether he won it. <em>Could become</em>: a credibility/social proof post — but only if the details hold up. Worth probing in the next session before doing anything with it.</li>
                    </ul>
                  </Callout>
                </div>
              </>
