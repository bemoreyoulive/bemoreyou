...
const afTodos = [
  { id: "w1", text: "Finalise the expo brochure and banner, with copy to the printers by Friday", subtext: "Lead with the accountancy hook we built: 'Accountancy firms run on retainers. Most of the work inside those retainers is still done by people.' Keep the pain points (drowning in manual processes, unable to take on new clients), the Sheldon of practice automation line, and your photo. Your wife is finishing the colours and spacing. Rename the prize to 'Five-Step AI Assessment' so it matches your LinkedIn. Send Ben the draft, then order the matching banner.", section: "This week", tabLink: undefined as { label: string; tab: string } | undefined },
  { id: "w2", text: "Prep and practise your 45-second BNI pitch for Friday", subtext: "You're going to BNI as the accountant's guest, then straight into your 1:1 with him. Open with 'Hi, I'm Andy, often called with affection the Sheldon of practice automation,' run the retainers pitch, and finish on a funny line so they remember you. Read from upright notes, hold eye contact, and bring energy. Visitors pitch last, when the room is tired, so make it land.", section: "This week", tabLink: undefined as { label: string; tab: string } | undefined },
  ...
  { id: "m1", text: "Keep the momentum going: continue with Ben from July", subtext: "You're hitting your stride just as the original block ends, which is the worst moment to drop the rhythm. The recommendation is to keep going: one 1:1 a month plus the group sessions for £325, down from £500. You keep Ben on tap for LinkedIn feedback, pitch and offer tweaks, pipeline calls, and the accountability nudge through the phase where conversations start turning into clients. The cadence is what keeps you moving. Have a think and let Ben know.", section: "Looking ahead", tabLink: undefined as { label: string; tab: string } | undefined },
