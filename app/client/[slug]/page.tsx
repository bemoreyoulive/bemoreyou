          ...
          <div>
            ...
            <div style={{background: "#fff", border: "1px solid #e4e2dc", borderRadius: 8, padding: "24px 26px", marginBottom: 20}}>
              ...
              {[
                ...
                { month: "September 2026", theme: "Schools pipeline + scale decisions", focus: "If the Pod placement worked, you should be in conversations with 2–3 more schools by now. Commercial model review — what are schools willing to pay, how does licensing actually work, who owns the relationship. Also: is the marketing assistant working out? Time to expand, or time to replace? Start mapping a possible schools-focused funnel separate from the parent one." },
