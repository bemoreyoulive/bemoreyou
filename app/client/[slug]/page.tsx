...
const afTodos = [
  { id: "e1", text: "Expo on Wednesday 1 July — go in ready to have conversations", subtext: "Your brochures are back from the printers and the banner is sorted. The organiser has already done a LinkedIn intro tagging accountants. Your job on the day is to start conversations, not wait for them. Ask what the practice looks like, let them land on the pain themselves. Aim for names and follow-up permission, not immediate sales.", section: "This week", tabLink: undefined as { label: string; tab: string } | undefined },
  { id: "e2", text: "Prep for Angela's meeting on Thursday 2 July at 9:30am", subtext: "Angela coaches accountants on client delivery and is already sharing your LinkedIn content. She mentioned a contact who might be a good fit once the timing is right. Treat this as a relationship-building conversation, not a sales call. Find out who she works with, what problems she sees in practices, and whether there is a natural referral relationship here.", section: "This week", tabLink: undefined as { label: string; tab: string } | undefined },
  { id: "e3", text: "Door-knock Loughborough accountants next week", subtext: "About eight practices in Loughborough, more in Leicester, Derby, and Nottingham after that. Walk in, introduce yourself, and lead with curiosity rather than a pitch: you are speaking to accountants to understand what slows their practices down. Have something to leave if they cannot chat. If they will not have a five-minute conversation about improving their business, they are not your client.", section: "Next week", tabLink: undefined as { label: string; tab: string } | undefined },
  { id: "e4", text: "Move on from the eight ghosted outreaches and find eight new ones", subtext: "You followed up twice with each of the eight warm outreaches and got nothing back. That is done. Find eight new accountancy practices to approach — use LinkedIn and the contacts coming through networking to build the list.", section: "Next week", tabLink: undefined as { label: string; tab: string } | undefined },
  { id: "p1", text: "Get the Chris Dillon R&D done", subtext: "This has been outstanding for a couple of weeks now. Phase 1 is a $12k deal, Phase 2 is around $30k and effectively committed once Phase 1 lands. Claire said she would use it herself if you prove it works. The R&D is straightforward in principle: prove you can pull the stats they need from their data using AI. Get it done and update Ben.", section: "Pipeline", tabLink: undefined as { label: string; tab: string } | undefined },
  { id: "m1", text: "Confirm the monthly retainer from July", subtext: "The main programme block is done. To keep the momentum going rather than going it alone, the plan is one session a month with Ben. Pricing to confirm. You wanted to talk it over with Zoe and Mike first.", section: "Looking ahead", tabLink: undefined as { label: string; tab: string } | undefined },
  { id: "s14", text: "Next session: Thursday 2 July at 8am — expo debrief, prep for Angela, and reflection close", subtext: "Ben is sending you some reflection questions in advance so you have time to think about them properly. First half of the session: expo debrief and prep for the Angela meeting at 9:30am. Second half: reflection questions and programme close.", section: "Next session", tabLink: undefined as { label: string; tab: string } | undefined },
];
        ...
        <div style={{ maxWidth: 1160, margin: "0 auto", padding: "10px 36px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div className="dash-nav-client" style={{ alignItems: "center", gap: 12 }}>
            ...
            <div>
              ...
              <p style={{ fontSize: "0.68rem", color: "#7A746E", margin: 0 }}>Founder, Equate Digital · June 2026 · Session 13</p>
            </div>
          </div>
      ...
      <div className="dash-page" style={{ maxWidth: 1160, margin: "0 auto" }}>
        ...
        {activeTab === "home" && (
          <div>
            ...
            <Callout type="green">
              <strong>Where we are, June 2026, post Session 13:</strong> Positioning locked. Five face-to-face networking events in two weeks and confidence visibly building. Expo stand on Wednesday 1 July. Door-knocking accountancy practices next week. Angela (accountant coach) meeting Thursday at 9:30am. Chris Dillon $12k deal still in play. <strong>Next session: Thursday 2 July at 8am, expo debrief, reflection close, and prep for Angela meeting.</strong>
            </Callout>
