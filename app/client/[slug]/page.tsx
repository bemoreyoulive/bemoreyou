...
const afTodos = [
  ...
  { id: "w4", text: "Coffee Chat with Olivia — booked for next Wednesday", subtext: "She handles business development at a client acquisition system company. Possible referral source or client.", section: "This week", tabLink: undefined as { label: string; tab: string } | undefined },
