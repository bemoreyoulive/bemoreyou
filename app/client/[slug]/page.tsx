...
const afTodos = [
  ...
  { id: "af2", text: "Work through your expo contacts when you get a window", subtext: "The process coach who wants to talk partnership, the SEO agency owner, and Kyle Brady with his accountant contacts are all worth a coffee chat. No rush on timing, just don't let the warm ones go cold. Follow up on the accountancy owner's introduction too.", section: "From the expo", tabLink: undefined as { label: string; tab: string } | undefined },
  { id: "af3", text: "Review your networking groups and cut the ones that aren't earning their place", subtext: "You've tried a lot of groups over the past six months. This is a good time to look honestly at which ones are actually bringing you value and drop the rest, rather than showing up out of habit.", section: "Ongoing", tabLink: undefined as { label: string; tab: string } | undefined },
  { id: "af4", text: "Get the Chris Dillon Phase 1 R&D over the line", subtext: "Still the biggest deal in the pipeline. Phase 1 is worth $12k with Phase 2 around $30k lined up behind it once it lands. Pick it up whenever you've got the headspace for it.", section: "Pipeline", tabLink: undefined as { label: string; tab: string } | undefined },
  { id: "af5", text: "Set up the warm email domains", subtext: "This has been sitting on the list for a while. It needs two to three weeks warming up before any outreach can use it, so starting it now saves you waiting later when you need it.", section: "Ongoing", tabLink: undefined as { label: string; tab: string } | undefined },
  { id: "af6", text: "Come back to Ben once you know what you need next", subtext: "You've said you need to take stock, whether that's more brand work, help with delivery, or just a proper break. No fixed date, just reach out when you're ready to figure out what's next.", section: "Looking ahead", tabLink: undefined as { label: string; tab: string } | undefined },
];
