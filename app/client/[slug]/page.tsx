...
const afContentStory = [
  ...
  { id: "af-story-2", hook: "\"Dad had Parkinson's. He hadn't left the house in three or four years. When the cancer came and it was quick, that was the blessing.\"", grade: 4, tag: "Unused", badge: "Long-form personal", priority: false, guidance: "Your dad. The slow Parkinson's years, the quick cancer at the end, and the line you used with Ben — \"in the end, it was a blessing.\" Then the bit a lot of people don't say out loud — that you processed it quickly, and not everyone in the family understood that. No business pivot at the end. No CTA. Just the story. Posts like this travel further than anything else you can write because half your ICP — practice owners in their 40s and 50s — are quietly going through some version of this right now. Be precise. Don't dress it up.", prompts: "What did the final few weeks actually look like? What's the thing you wish someone had said to you at the time? Why do you think you processed it quicker than the rest of the family?", cta: "" },
  { id: "af-story-3", hook: "\"Mum wouldn't get her hip operation done while Dad was still here. Then she waited 18 months on the NHS. I'm running a business in the middle of all of that.\"", grade: 3, tag: "Unused", badge: "Long-form personal", priority: false, guidance: "The sandwich-year post. Mum refusing the operation while Dad was still alive with Parkinson's. Eighteen months on the NHS waiting list once she was free to do it. The hip op over New Year, the DVT after. The \"in and out this week, taking it as it comes\" rhythm of running a business while alternating hospital visits. End on the systems point if you want to — if my business needs me sitting in front of it every day, I can't be at the hospital. But the post stands without that. Universal for the 45–60 ICP.", prompts: "What's the bit of running a business through that period that other people don't see? What did you have to let go of? What kept holding up while everything else wobbled?", cta: "" },
